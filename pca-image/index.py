...
additional_info  =  {"input_file" : None, "output_model_dir" : None, "output_data_dir" : None, "output_file" : None}
input_file_spec_info = {"csv_encoding" : "default", "input_file_format" : "csv"}
hyperparameter_info = {"PCA_component" : 5}  
...
def download_files_from_S3_to_RESTful(local_file):
	...
	try:
		session.resource('s3').Bucket(aws_credential_info['bucket_name']).download_file(additional_info['input_file'], local_file)
